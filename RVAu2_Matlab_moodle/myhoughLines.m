...
%executar com
%[lines, rect] = myhoughLines('Imagens/livros.png', 'Imagens/livro4.png');

% função que determina as linhas de Hough a partir da imagem
% e retorna as linhas horizontais e verticais
function [lines, rect] = myhoughLines(pathImage, pathBookTemplate) 
...
%    [point1, ~, point3, ~, found] = findBook(Image, imread(pathBookTemplate), -1, -1);
% 
%     if found
